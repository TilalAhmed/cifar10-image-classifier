...
.hero-title {
    ...
    font-size: 2.8rem;
    letter-spacing: -1px;
    background: linear-gradient(135deg, #0055cc 0%, #0099ff 60%, #5500cc 100%);
...
.styled-divider {
    height: 1px;
    background: linear-gradient(90deg, #0066ff, #0099ff, transparent);
    margin: 1.2rem 0;
}
...
[data-testid="stFileUploader"] {
    ...
    border: 1px dashed #aac4e0 !important;
...
[data-testid="stSidebar"] {
    ...
    border-right: 1px solid #c0d4f0 !important;
}

/* Progress bar */
.stProgress > div > div > div {
    background: linear-gradient(90deg, #0055cc, #0099ff) !important;
}
...
with st.sidebar:
    ...
    <div style='font-family:Space Mono,monospace; font-weight:700; font-size:1rem;
         color:#0055cc; letter-spacing:2px; margin-bottom:0.3rem;'>
        CIFAR-10
    </div>
    <div style='font-family:Space Mono,monospace; font-size:0.65rem; color:#6688aa;
    ...
    for cls in CLASSES:
        ...
        st.markdown(
            ...
            f"color:#336699; padding:0.25rem 0;'>{icon} {cls.upper()}</div>",
            unsafe_allow_html=True
        )

    st.markdown("<div style='height:1px; background:linear-gradient(90deg,#0099ff,transparent); margin:1rem 0;'></div>", unsafe_allow_html=True)

    st.markdown("""
    <div style='font-family:Space Mono,monospace; font-size:0.65rem; color:#6688aa; line-height:1.8;'>
        Architecture: CNN<br>
        Input: 32×32×3<br>
        Conv layers: 2<br>
...
with left:
    st.markdown("<div style='font-family:Space Mono,monospace; font-size:0.75rem; color:#6688aa; text-transform:uppercase; letter-spacing:2px; margin-bottom:0.5rem;'>Upload Image</div>", unsafe_allow_html=True)
...
with right:
    if classify_btn:
        if not uploaded_file:
            ...
            for idx in top5_idx:
                ...
                st.markdown(
                    ...
                    f"color:#6688aa; text-align:right; margin-top:-0.8rem; "
        ...
        st.markdown("""
        <div style='background:#ffffff; border:1px solid #c8ddf0; border-radius:12px;
             padding:2rem; text-align:center; margin-top:1rem;'>
            <div style='font-size:3rem; margin-bottom:1rem;'>🔭</div>
            <div style='font-family:Space Mono,monospace; font-size:0.8rem;
                 color:#6688aa; text-transform:uppercase; letter-spacing:2px;'>
